<%@page import="com.manisha.toursandtravels.pojo.Package"%>
...
<%-- 		<% } %> --%>
	...
	<tr>
		...
		<td>
			<a class="btn btn-primary" href="package?action=update&packageId=<%=pkg.getPackageId() %>" onclick="return confirm('Do you wanna update this package')">Update</a>
		</td>
		<td>
			<a class="btn btn-primary" href="package?action=delete&packageId=<%=pkg.getPackageId() %>" onclick="return confirm('Do you wanna delete this package')">Delete</a>
		</td>
		<% }%>
		<td>
			<a class="btn btn-primary" href="trip?action=showtripbypackage&packageId=<%=pkg.getPackageId() %>">Trip's</a>
		</td>
	</tr>
	<%} %>
</table>
