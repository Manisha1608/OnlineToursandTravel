...
import com.manisha.toursandtravels.dao.TripDao;
...
public class TripDaoImpl implements TripDao
{
	...
	{
		sqlQuery= "insert into trips_408 (packageId,fromCity,fromDate,toDate )values(?,?,?,?)";
		try
		{
	...
	public List<Trips> showTrips() 
	{
		...
		sqlQuery="select * from trips_408 natural join package_408";
	...
	public List<Trips> showTripByPackage(int packageId) {
		...
		List<Trips> triplist = new ArrayList<>();
		sqlQuery = "select * from trips_408 natural join package_408  where packageId=?";
	...
	public boolean updateTrip(Trips trip) {
		sqlQuery="update trips_408 set packageId=? ,fromCity =? ,fromDate=?, toDate=? where tripId=?";
	...
	{
		sqlQuery="delete from trips_408 where tripId=?";
		try
		{
			ps = con.prepareStatement(sqlQuery);
			ps.setInt(1,tripId);
	...
	{
		sqlQuery = "select * from trips_408 natural join package_408 where tripId=?";
