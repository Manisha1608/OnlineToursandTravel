            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        ...
                        <div class="content">
                            <a class="d-flex align-items-center" href="trip?action=showtripbypackage&packageId=8"> Italy </a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_destination">
                        ...
                        <div class="content">
                            <a class="d-flex align-items-center" href="trip?action=showtripbypackage&packageId=9">Brazil </a>
